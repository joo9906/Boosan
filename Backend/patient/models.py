...
class Patient_data(models.Model):
    ...
    HR = models.IntegerField(verbose_name='심박수')
    sbp = models.IntegerField(verbose_name='최고 혈압')
    dbp = models.IntegerField(verbose_name='최저 혈압')
    CC = models.CharField(max_length=200, verbose_name='주 증상')
    pain_area = models.CharField(max_length=100, verbose_name='통증 부위')
    pain_level = models.IntegerField(verbose_name='통증 정도 (0~10)')
    RR = models.IntegerField(verbose_name='호흡수')
    BT = models.FloatField(verbose_name='체온')
